...
public class PlayerSetupDialog extends JDialog implements ActionListener,
	...
	public PlayerSetupDialog(JFrame parent, CheckersPlayerInterface player1,
		...
		super(parent, config.getString("PlayerSetuppp"), true);
		...
		TitledBorder border = BorderFactory.createTitledBorder(
				CheckersGUI.BORDER, config.getString("Playeum"));
	...
	public void itemStateChanged(ItemEvent e) {
		try {
			if (e.getSource() == comboBox1) {
				player1 = CheckersPlayerLoader.getPlayerClass(
						comboBox1.getSelectedIndex()).newInstance();
				...
				player2 = CheckersPlayerLoader.getPlayerClass(
						comboBox2.getSelectedIndex()).newInstance();
