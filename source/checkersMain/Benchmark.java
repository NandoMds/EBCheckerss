...
public final class Benchmark {
	...
	public static void spaceEfficiencyBenchmark(CheckersBoard... boards) {
		System.out.println(config.getString("SpaceEfficiencyBenchmark"));
		System.out.println("-------------------------");
		...
		for (int i = 0; i < boards.length; i++) {
			for (int j = 0; j < 3; j++) {
				...
				list.clear();
				System.gc();
				System.out.println(boardNames[i] + " " + config.getString("Sz") +": " + size);
			}
		}
	...
	public static void timeEfficiencyBenchmark(CheckersBoard... boards) {
		System.out.println(config.getString("TimeBenchmark"));
		System.out.println("-------------------------");
		...
		for (int i = 0; i < clones.length; i++)
			System.out.println(boardNames[i] + " " + config.getString("Time") +":\t" + boardTimes[i]);

		for (int i = 0; i < clones.length; i++)
			clones[i] = boards[i].clone();
		Arrays.fill(boardTimes, 0);
		System.gc();
		System.out.println("\n"+config.getString("SettersTest"));
		...
		Arrays.fill(boardTimes, 0);
		System.gc();
		System.out.println("\n" + config.getString("InversionTest"));
		...
		Arrays.fill(boardTimes, 0);
		System.gc();
		System.out.println("\n"+config.getString("PliesGenerationTest"));
		for (int i = 0; i < 1000000; i++) {
			for (int j = 0; j < clones.length; j++) {
				oldTime = System.currentTimeMillis();
		...
		Arrays.fill(boardTimes, 0);
		System.gc();
		System.out.println("\n"+config.getString("SuccessorsGenerationTests"));
		for (int i = 0; i < 1000000; i++) {
			for (int j = 0; j < clones.length; j++) {
				oldTime = System.currentTimeMillis();
		...
		Arrays.fill(boardTimes, 0);
		System.gc();
		System.out.println("\n"+config.getString("CheckersSTest"));
		for (int i = 0; i < 8; i++) {
			for (int j = 0; j < clones.length; j++) {
				oldTime = System.currentTimeMillis();
