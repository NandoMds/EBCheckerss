	...
	private class GameThread extends Thread {
		...
		public boolean playerPly(CheckersPlayerInterface player) {
			...
			if (playerMoveIndex < 0 || playerMoveIndex >= numPlies) {
				System.out.println(player.getName() + " " + config.getString("InvalidIndex") + " "
						+ playerMoveIndex + " " + config.getString("Moverandomly"));
		...
		public void run() {
			...
			System.out.println("\n" + config.getString("NewCheckersGames"));
			...
			for (moveCount = 1;; moveCount++) {
				...
				if (playerPly(player1)) {
					...
					if (printBoard) {
						System.out.println(config.getString("Player1moves"));
				...
				if (playerPly(player2)) {
					...
					if (printBoard) {
						System.out.println(config.getString("Player2moves"));
						System.out.println(board.toString());
					}
					// Notify listeners that a ply has been taken
					ce = new CheckersGameEvent(CheckersGameManager.this);
			...
			case PLAYER1_WINS:
				System.out.println("~~~~~\n" + player1.getName()
						+ " " + config.getString("winsagainsttt") + " " + player2.getName() + " " + config.getString("in") + " " + 
						+ moveCount + " " + config.getString("turnsturns") + " " +  "!\n~~~~~");
				break;
			case PLAYER2_WINS:
				System.out.println("~~~~~\n" + player2.getName()
				+ " " + config.getString("winsagainsttt") + " " + player1.getName() + " " + config.getString("in") + " " 
						+ moveCount + " " + config.getString("turnsturns") + " " + "!\n~~~~~");
				break;
			case DRAW:
				System.out.println("~~~~~\n" + player1.getName() + " " + config.getString("andd") + " "
						+ player2.getName() + " " + config.getString("drawafterr") + " " + moveCount
						+ " " + config.getString("turnsturns") +".\n~~~~~");
				break;
			default:
				System.out.println(config.getString("GameThreadInterrupted"));
			}
