...
public class BadCheckersPlayer implements CheckersPlayerInterface {
	...
	public String getDescription() {
		return config.getString("Atime-gobblingAIthatusesasimpleiterativedeepeningsearchwitha")
				+ " " +  config.getString("mini-maxalgorithm.")
				+ " " +  config.getString("willtakeupmostof")
				+ "\n\nAuthor: Bichen Wang" + "\nVersion: 1.00 - 10 July 2008";
	}

	@Override
	public String getName() {
		return config.getString("TheBadCheckersPlayer");
	}
