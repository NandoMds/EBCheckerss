...
public class HAL900 implements CheckersPlayerInterface {
	...
	public String getDescription() {
		return config.getString("Anthatusesadepth-limited")
				+ " " + config.getString("searchalpha-beta")
				+ " " + config.getString("pruningItalsheuristicandmodifies")
				+ " " + config.getString("itssearchdepthdynamically")
				+ "\n\nAuthor: Amos Yuen and Louis Wang\nVersion: " + VERSION;
	}
